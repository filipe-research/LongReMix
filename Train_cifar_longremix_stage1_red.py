...
parser.add_argument('--data_path', default='../../datasets/red_blue/mini-imagenet/', type=str, help='path to dataset')
parser.add_argument('--dataset', default='mini_imagenet32_red', type=str)
